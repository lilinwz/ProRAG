...
if __name__ == "__main__":
    file_name = "/home/v-zhaowan/ds/zhaowang/rag/data/MulSiQue/musique_ans_v1.0_train.jsonl"
    read_jsonl_head(file_name)
    print(len(data))
    print(data[0])
    with open("/home/v-zhaowan/ds/zhaowang/rag/data/raw/mulsique.json", "w") as f:
