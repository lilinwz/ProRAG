...
def main(args):
    ...
    full_dataset = Dataset.from_dict({
        ...
        "history": [d["history"] for d in raw_data],
        "completion": [d["completion"] for d in raw_data],
    })
    ...
    processed_train_dataset = train_dataset.map(preprocess_function, batched=True, remove_columns=["id", "history", "completion"])
    processed_eval_dataset = eval_dataset.map(preprocess_function, batched=True, remove_columns=["id", "history", "completion"])
